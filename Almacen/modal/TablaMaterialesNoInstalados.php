...
<head>
    ...
    <style>
        ...
        .dataTables_wrapper .dataTables_length select { padding: .375rem 1.75rem .375rem .75rem; }
        .dataTables_wrapper .dataTables_paginate .paginate_button { padding: .5rem .75rem; }
        .dataTables_wrapper .dataTables_paginate .paginate_button.current { background: #4e73df; border-color: #4e73df; color: white !important; }
        .dataTables_wrapper .dataTables_paginate .paginate_button:hover { background: #2e59d9; border-color: #2653d4; color: white !important; }
...
// Obtener materiales no instalados
$filas = $modal->MaterialesNoInstalados($Fecha1, $Fecha2);
...
<table class="table table-bordered display nowrap" style="width:100%" id="ventas">			
    ...
    <?php
        foreach($filas as $row){
            ...
            $fecha_salida = new DateTime($row['Fecha_Salida_Det']);
            $hoy = new DateTime();
            $dias_diferencia = $fecha_salida->diff($hoy)->days;

            if (is_numeric($dias_diferencia)) {
                ...
                $color = "#bdc3c7"; // Gris (fecha inválida o vacía)
                $textColor = "#000";
            }

            echo "
            <tr>
                <td style='background-color: $color !important; color: $textColor !important; font-weight: bold;'>".$row['Folio_Salida_Det']."</td>
                <td style='background-color: $color !important; color: $textColor !important; font-weight: bold;'>".strtoupper($row['Contratista'] ?? '')."</td>
                <td style='background-color: $color !important; color: $textColor !important; font-weight: bold;'>".strtoupper($row['Tecnico'] ?? '')."</td>
                <td style='background-color: $color !important; color: $textColor !important; font-weight: bold;'>".$row['Producto']."</td>
                <td style='background-color: $color !important; color: $textColor !important; font-weight: bold;'>".$row['Num_Serie_Salida_Det']."</td>
                <td style='background-color: $color !important; color: $textColor !important; font-weight: bold;'>".$row['Fecha_Salida_Det']."</td>
            </tr>";
